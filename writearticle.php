                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form name="register" id="register" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="post" autocomplete="off" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label for="articleheader" class="col-md-2 control-label"><span class="text-info">Header<br /><small><span class="text-danger">Beste afmeting is 500x300 pixels</span></small></span></label>
                                            <div class="col-md-10" id="headdiv">
                                                <input type="file" id="headerimage" name="headerimage" accept="image/*" required>
                                                <input type="text" readonly="" class="form-control" placeholder="Kies een afbeelding" id="headertext">
                                                <script>
                                        ...
                                        <div class="form-group">
                                            <label for="articleimage" class="col-md-2 control-label"><span class="text-info">Artikel afbeelding(en)<br /><small><span class="text-danger">Beste afmeting is 500x300 pixels.</span></small></span></label>
                                            <div class="col-md-10" id="articlediv">
                                                <input type="file" id="articleimage" name="articleimage" accept="image/*" onchange="loadBodyPreview(this)" required>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-danger">Het verwerken van een artikel kan eventjes duren! Dus heb geduld tijdens heb posten van je artikel.</p>
